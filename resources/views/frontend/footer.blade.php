<style>
    ...
    .footer-demo::before {
        ...
        right: 0;
        bottom: 0;
        background: url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 100" fill="rgba(255,255,255,0.03)"><polygon points="0,0 1000,0 1000,60 0,100"/></svg>');
    ...
    .social-links .btn:nth-child(1):hover {
        background: linear-gradient(45deg, #1877f2, #42a5f5);
    }

    .social-links .btn:nth-child(2):hover {
        background: linear-gradient(45deg, #1da1f2, #42a5f5);
    }

    .social-links .btn:nth-child(3):hover {
        background: linear-gradient(45deg, #ff0000, #ff5722);
    }

    .social-links .btn:nth-child(4):hover {
        background: linear-gradient(45deg, #e4405f, #f06292);
    }

    .social-links .btn:nth-child(5):hover {
    ...
    .footer-demo .nav-link:hover {
        color: #ffffff !important;
        transform: translateX(5px);
    }

    .footer-demo .nav-link:hover::before {
        width: 100%;
    }
...
<footer class="footer-demo py-5">
    <div class="footer-content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6 mb-4 fade-in">
                    <div class="footer-menu">
                        <div class="d-flex align-items-center mb-3">
                            <div style="width: 40px; height: 40px; background: linear-gradient(45deg, #4facfe, #00f2fe); border-radius: 8px; display: flex; align-items: center; justify-content: center; margin-right: 10px;">
                                <img src="{{ asset('assets/images/takex_logo_clean.png') }}" alt="TakeX Logo" width="24" height="24" style="filter: brightness(0) invert(1);">
                            </div>
                            <h4 class="mb-0" style="color: #ffffff; font-weight: 700;">TakeX</h4>
                        </div>
                        <p style="color: rgba(255,255,255,0.8); margin-bottom: 2rem;">Cửa hàng thực phẩm tươi sống hàng đầu Việt Nam. Chất lượng tốt nhất, giá cả hợp lý.</p>
                ...
                <div class="col-md-2 col-sm-6 mb-4 fade-in">
                    <div class="footer-menu">
                        ...
                        <ul class="menu-list list-unstyled">
                            ...
                            <li class="menu-item">
                                <a href="#" class="nav-link">Chương trình đại lý</a>
                            </li>
                            <li class="menu-item">
                ...
                <div class="col-md-2 col-sm-6 mb-4 fade-in">
                    <div class="footer-menu">
                        ...
                        <ul class="menu-list list-unstyled">
                            <li class="menu-item">
                                <a href="{{ url('/category/do-chay') }}" class="nav-link">Rau củ quả tươi</a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ url('/category/do-an') }}" class="nav-link">Thịt cá</a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ url('/category/ngon-lanh') }}" class="nav-link">Sữa & Trứng</a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ url('/category/do-an') }}" class="nav-link">Thực phẩm khô</a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ url('/category/do-uong') }}" class="nav-link">Đồ uống</a>
                            </li>
                            <li class="menu-item">
                                <a href="#" class="nav-link">Đồ gia dụng</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 mb-4 fade-in">
                    <div class="footer-menu">
                        ...
                        <p style="color: rgba(255,255,255,0.8); margin-bottom: 1.5rem;">Đăng ký để nhận thông báo về các ưu đãi và sản phẩm mới nhất từ chúng tôi.</p>
                        <div class="newsletter-form">
                            <form class="d-flex gap-0" role="newsletter">
                                <input class="form-control" type="email" placeholder="Nhập địa chỉ email của bạn" aria-label="Email Address">
...
<script>
    ...
    document.querySelector('form[role="newsletter"]').addEventListener('submit', function(e) {
        e.preventDefault();
