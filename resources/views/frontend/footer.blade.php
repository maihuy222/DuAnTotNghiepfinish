                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6 mb-4 fade-in">
                        <div class="footer-menu">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <h4 class="mb-0" style="color: #ffffff; font-weight: 700;">FoodMart</h4>
                            </div>
                    ...
                    <div class="col-md-2 col-sm-6 mb-4 fade-in">
                        <div class="footer-menu">
                            ...
                            <ul class="menu-list list-unstyled">
                                <li class="menu-item">
                                    <a href="#" class="nav-link">Rau củ quả tươi</a>
                                </li>
                                <li class="menu-item">
                                    <a href="#" class="nav-link">Thịt cá</a>
                                </li>
                                <li class="menu-item">
                                    <a href="#" class="nav-link">Sữa & Trứng</a>
                                </li>
                                <li class="menu-item">
                                    <a href="#" class="nav-link">Thực phẩm khô</a>
                                </li>
                                <li class="menu-item">
