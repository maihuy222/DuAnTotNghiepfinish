...
<main class="app-content">
    <div class="app-title">
        <ul class="app-breadcrumb breadcrumb side">
            ...
            <li class="breadcrumb-item active"><a href="#"><b>Thêm quảng cáo mới</b></a></li>
        </ul>
        <div id="clock"></div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                <div class="tile-header">
                    <h3 class="tile-title">Thêm quảng cáo mới</h3>
                </div>
                <div class="tile-body">
                    <form id="createSliderForm" enctype="multipart/form-data">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <ul class="list-unstyled">
                                            ...
                                            <li><i class="fas fa-image text-success"></i> Hình ảnh là bắt buộc</li>
                        ...
                        <div class="tile-footer">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Lưu quảng cáo
                            </button>
...
$('#createSliderForm').on('submit', function(e) {
    ...
    $.ajax({
        ...
        error: function(xhr) {
            var message = "Có lỗi xảy ra khi thêm quảng cáo";
